<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<Aktel.Mvc.Models.SearchResultsViewModel>" %>
...
<body class="main_bg">
    <div class="content">
                    ...
                    <div class="center-wrapper">
                        <div id="navigation">
                            <ul class="tabbed" style="text-transform: capitalize;">
                                ...
                                <li><a>&rsaquo;&rsaquo;</a></li>
                                <li><a href="#">Search: <%=Html.Encode(Model.searchString)%></a></li>
                            </ul>
                            <div class="clearer">
                                &nbsp;</div>
                        </div>
        ...
        <div id="productsByAllFilters" style="padding: 3px 5px 10px 5px;">
            <span class="content_title"><span class="content_title_sidebar_filter">Products Search By &rsaquo;
                <%= Html.Encode(Model.searchString) %>
            </span>
                <%Html.RenderPartial("RenderProduct", Model.Products);%>
            </span>
        </div>
    </div>
</body>
