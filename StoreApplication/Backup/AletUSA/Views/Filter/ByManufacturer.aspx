<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<Aktel.Domain.Manufacturer>" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Aktel - Product by
        <%=Model.Name%></title>
                    ...
                    <div class="content" id="content-two-columns">
                        <div id="main-wrapper">
                            <div style="padding: 12px 10px 10px 10px;">
                                ...
                                <% Html.RenderPartial("RenderProduct", Model.GetAllAssociatedProducts());   %>
                            </div>
                        </div>
                        <div id="sidebar-wrapper">
                            <div id="sidebar">
                                <% //Html.RenderPartial("RenderDefaultSidebar");
